...
// const ChatDisplay = () => {
//   // Get active thread and messages from the context
//   const { activeThread, setActiveThread, threads } = useContext(ChatContext);  // Assuming you are storing threads in context
